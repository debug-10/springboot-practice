package top.guke.springboot.redis.utils;
...
import top.guke.springboot.redis.constant.Constant;
...
//盐值很重要，不能泄漏，且每个项目都应该不一样，可以放到配置文件中米
private static final String KEY = "hello-world";

public static String createToken(Long userId){
    DateTime now= DateTime.now();//超时时间
